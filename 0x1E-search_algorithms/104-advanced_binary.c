...
int advanced_binary(int *array, size_t size, int value)
{
	...
	return (advanced_binary_aux(array, value, start, end, size));
}
...
int advanced_binary_aux(int *array, int value, int start, int end, int size)
{
	int mid = 0, i = 0;
	...
	if (array[mid] == value)
		return (mid);
	if (value > array[mid])
		return (advanced_binary_aux(array,
